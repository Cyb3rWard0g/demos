...
```
SELECT S.COMPUTER_NAME, S.EVENT_DATA->PROCESSGUID , S.EVENT_DATA->IMAGE FROM WINLOGBEAT_STREAM S WHERE WHERE S.SOURCE_NAME='Microsoft-Windows-Sysmon' AND S.EVENT_ID=1 LIMIT 5;
..
...
```
